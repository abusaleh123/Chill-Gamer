...
const AllReviewCard = ({reviews}) => {
    ...
    return ( 
        <div className="h-full">
            <Zoom>
            <div className='bg-white/40 backdrop-blur-md   pb-6 rounded-xl h-full text-white'>
                <img className=' object-cover h-52 w-full rounded-t-xl' src={cover} alt="" />
               <div className='flex justify-between px-4 mt-2'>
               <div className="flex items-center gap-2">
                    <p className="text-lg font-bold text-white rating rating-sm">  <input type="radio" name="rating-9" className="rating-hidden" />
                    <input type="radio" name="rating-9" className="mask mask-star-2" /></p>
               ...
               <p className='text-white/70  h-16 px-2'>{review}</p>
